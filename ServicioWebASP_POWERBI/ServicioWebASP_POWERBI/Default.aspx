<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ServicioWebASP_POWERBI._Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container row text-center m-2">
        ...
        <div class="card col-lg-3 col-md-4 col-sm-6 m-2 p-3">
            ...
            <div class="card-body">
                <div class="card-title">
                    <h2>Consulta sobre el uso de transporte!</h2>
                </div>
                <div class="card-text" style="max-height: 60px; overflow: hidden;">
                    <p>Respondenos unas preguntas!</p>
                </div>
         ...
         <div class="card col-lg-3 col-md-4 col-sm-6 m-2 p-3">
            ...
            <div class="text-center">
                <a class="btn btn-primary" href="Reportes.aspx">Ir</a>
            </div>
        </div>
