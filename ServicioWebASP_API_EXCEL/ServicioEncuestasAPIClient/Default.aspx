...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container row text-center m-2">
        ...
        <div class="card col-lg-3 col-md-4 col-sm-6 m-2 p-3">
            ...
            <div class="text-center">
                <asp:LinkButton class="btn btn-primary" ID="LinkButton1" OnClick="LinkButton1_Click" runat="server"><i class="fa fa-download" aria-hidden="true"></i>Descargar</asp:LinkButton>
            </div>
        </div>
